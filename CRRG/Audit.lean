...
theorem Frontier.rootIs {root : Goal} {P : Prop} (_front : Frontier root)
...
theorem Frontier.leafIs {root : Goal} {P : Prop} (front : Frontier root)
...
theorem SealedCandidate.targetIs {P Q : Prop} (_c : SealedCandidate P)
...
/-- Verify that a resolved candidate really is certified, and extract the proof
    ...
    is not a promotion. -/
theorem ResolvedCandidate.certifiedProof {P : Prop} (r : ResolvedCandidate P)
