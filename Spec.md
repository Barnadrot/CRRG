...
**Status:** v0.10.0 — the persistence layer (§28–§36) is implemented, audited, and **live on the Yukon lane** (`proximity-research` `crrg-yukon` @ `a09874929`); External Review 2 complete.  
